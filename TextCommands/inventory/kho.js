    ...
    try {
      ...
      const caEmbed = new Discord.EmbedBuilder()
        ...
        const sanPhamEmbed= new Discord.EmbedBuilder()
          ...
          .setDescription(
            `
            \`303\` |  <:eje_minecraft_milk:1156555171493597204> Sữa: 
            \`304\` |  <:Minecraft_Egg:1156555165189550101> Trứng: 
            \`305\` |  <:rawporkchop76:1166408633622482964> Thịt heo: 
            \`306\` |  <:6289_flour:1155701022891704360> Bột mì: 
            \`307\` |  <:butterTT:1157319277335035974> Bơ: 
            \`308\` |  <:6429_minecraft_bread:1167391995245891716> Bánh mì: 
            \`309\` |  <:Item_Delicious_Tuna_Sushi:1167391997506629632> Shushi: 
            \`310\` |  <:Open_Canned_Sardines46:1167392001436700712> Cá đóng hộp: 
            `
          )
